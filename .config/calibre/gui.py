...
main_search_history = cPickle.loads('\x80\x02]q\x01(X\x12\x00\x00\x00cloud of unknowingq\x02X\x03\x00\x00\x00vimq\x03X\x04\x00\x00\x00yogaq\x04X\t\x00\x00\x00forbiddenq\x05X\x06\x00\x00\x00pollanq\x06X\x06\x00\x00\x00mertonq\x07X\x07\x00\x00\x00fermentq\x08X\n\x00\x00\x00traditionsq\tX\x04\x00\x00\x00kingq\nX\x0c\x00\x00\x00authors:trueq\x0bX\x12\x00\x00\x00authors:true wattsq\x0cX\n\x00\x00\x00alan wattsq\re.')
 
# viewer search history
# Search history for the e-book viewer
viewer_search_history = cPickle.loads('\x80\x02]q\x01X\x04\x00\x00\x00beetq\x02a.')
